...
<form id="queryForm">
    <label for="week_start">location ID:</label>
    <input type="text" id="location_id"><br><br>
...
`;
    ...
    document.getElementById("queryForm").addEventListener("submit", function (e) {
        ...
        const weekStart = document.getElementById("location_id").value;

        // Replace placeholders in the SQL query
        let finalQuery = baseSqlQuery.replaceAll("@location_id", `'${weekStart}'`);
