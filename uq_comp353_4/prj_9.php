...
<form id="queryForm">
    <label for="location_id">family member id:</label>
    <input type="number" id="location_id" name="location_id" value="18"><br><br>
...
`;
    ...
    document.getElementById("queryForm").addEventListener("submit", function (e) {
        ...
        let finalQuery = baseSqlQuery.replaceAll("@family_member_id", locationId);
